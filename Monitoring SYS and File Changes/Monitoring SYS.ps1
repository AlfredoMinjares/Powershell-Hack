...
$SYS = [Environment]::GetFolderPath('Desktop')
...
try
{
  ...
  $action = {
    ...
    $text = "{0} -- {1} | {2}" -f $Timestamp, $ChangeType, $FullPath
    Write-Host ""
    Write-Host $text -ForegroundColor DarkYellow
    Add-Content -Path "C:\Users\cjs-josem\Documents\Cursos\LogFile.txt" -Value $text
